...
//luces spotlight
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glm::vec3 lowerLight1 = glm::vec3 (mainWindow.getmuevex(), 0.0f, mainWindow.getMovZ());
		lowerLight1.y -= 0.1f;
		spotLights[1].SetFlash(lowerLight1, glm::vec3(mainWindow.getmuevex(), -1.0f, mainWindow.getMovZ()));

		shaderList[0].SetDirectionalLight(&mainLight);
		shaderList[0].SetPointLights(pointLights, pointLightCount);
		//shaderList[0].SetSpotLights(spotLights, spotLightCount);

		if (mainWindow.getencluz() == 1.0f)
		{
			shaderList[0].SetSpotLights(spotLights, spotLightCount);
		}
		else
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(mainWindow.getmuevex(), 0.0f, mainWindow.getMovZ()));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Material_brillante.UseMaterial(uniformSpecularIntensity, uniformShininess);
		paisajes.UseTexture();
